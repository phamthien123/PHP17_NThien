...
<head>
    <?php require_once 'admin/html/head.php'; ?>
</head>
...
<body class="stretched overlay-menu">
    ...
    <div id="wrapper" class="clearfix bg-light">
        ...
        <div class="container-fluid">
            <div class="row">
                <!-- Content -->
                <?php require_once 'admin/html/header.php'; ?>
        ...
        <?php require_once 'admin/html/footer.php'; ?>
    </div>

    <!-- Go To Top
	============================================= -->
    <div id="gotoTop" class="icon-angle-up rounded-circle"></div>
    <?php require_once 'admin/html/script.php'; ?>
